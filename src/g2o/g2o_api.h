...
void AddVertexSBAPointXYZ(Optimizer &opt, const g2o::Vector3D &xyz, int id, bool marginal=false); //leather add
...
g2o::EdgeUV_SE3_XYZ* AddEdgeUV_SE3_XYZ(Optimizer &opt, int idKf, int idMp, int idCamParam, const g2o::Vector2D &measure, const g2o::Matrix2D &info);
